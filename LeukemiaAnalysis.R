...
ggplot(leukemia_data,aes(x=`Cause of death source`, y=`Bone Marrow Blast Percentage`))+
  geom_boxplot(aes(fill = `Cause of death source`)) + 
  ggtitle("Distribution of Bone Marrow Blast Percentage for Patients Who Lived vs. Died") +
  xlab("Cause of Death")+ylab("Bone Marrow Blast Percentage")

ggplot(leukemia_data,aes(x=`Cause of death source`, y=`Hemoglobin level`))+
  geom_boxplot(aes(fill =`Cause of death source`)) + 
  ggtitle("Distribution of Hemoglobin Levels for Patients Who Lived vs. Died") +
  xlab("Cause of Death")+ylab("Hemoglobin Level")

logREG<-glm(formula=as.factor(`Cause of death source`)~`Bone Marrow Blast Percentage` + 
...
ggplot(leukemia_data, aes(x = `Cause of death source`, y = fitted_values)) + 
  geom_boxplot(aes(fill = `Cause of death source`)) + 
  ggtitle("Comparison of the Model to the Actual Cause of Death") + 
  xlab("Actual Cause of Death") + ylab("Fitted Values") + theme(legend.position = "none")
